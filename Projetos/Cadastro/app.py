...
from Projetos.Cadastro.Users import Usuarios
from tkinter import *
...
class Application:
    ...
    def inserirUsuario(self):
        try:
            ...
            tkinter.messagebox.showerror("Error!", "Não foi possível inserir! \n %s" % ex)
    ...
    def alterarUsuario(self):
        try:
            ...
            tkinter.messagebox.showerror("Error!", "Não foi possível alterar! \n %s" % ex)
    ...
    def excluirUsuario(self):
        try:
            ...
            tkinter.messagebox.showerror("Error!", "Não foi possível excluir! \n %s" % ex)
    ...
    def buscarUsuario(self):
        try:
            ...
            tkinter.messagebox.showerror("Error!", "Não foi possível consultar! \n %s" % ex)
