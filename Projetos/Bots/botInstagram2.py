...
class InstagramBot:
    def __init__(self, username, password):
        ...
        self.driver = webdriver.Firefox(
            firefox_profile=firefoxProfile, executable_path=r"C:\Users\leo_n\Downloads\geckodriver.exe"
        )
...
jhonatanBot = InstagramBot("seuUsuario", "suaSenha")  # Entre com o usuário e senha aqui
jhonatanBot.login()