...
if __name__ == '__main__':
    ...
    w1 = multiprocessing.Process(name='bloco', target=espera_por_evento, args=(e,))
    w1.start()

    w2 = multiprocessing.Process(name='não-bloco', target=espera_por_evento_timeout, args=(e, 2))
    w2.start()
